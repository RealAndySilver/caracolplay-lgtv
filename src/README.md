...
the header and footer. It declares with `ngApp` that this is `caracolplaylgtvapp`,
...
"caracolplaylgtvapp" will rename the resultant CSS and JavaScript placed in `build/`,
